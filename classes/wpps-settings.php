...
if ( ! class_exists( 'WPPS_Settings' ) ) {
	...
	class WPPS_Settings extends WPPS_Module {
		 ...
		 * @param array  $value This will be merged with WPPS_Settings->settings, so it should mimic the structure of the WPPS_Settings::$default_settings. It only needs the contain the values that will change, though. See TreasureIsland->upgrade() for an example.
		 */
		...
		public function validate_settings( $new_settings ) {
			...
			if ( ! is_string( $new_settings['db-version'] ) ) {
				$new_settings['db-version'] = TreasureIsland::VERSION;
			}
