...
<head>
	...
	<link href="<?php echo $theme_path;?>app/css/2.f005c5ff.chunk.css" rel="stylesheet">
  <link href="<?php echo $theme_path;?>app/css/main.1fec0d7c.chunk.css" rel="stylesheet">
...
<body>
	...
	<script type="text/javascript" src="<?php echo $theme_path;?>app/js/main.f1858841.chunk.js"></script>
  <script type="text/javascript" src="<?php echo $theme_path;?>app/js/runtime-main.13df2b21.js"></script>
  <script type="text/javascript" src="<?php echo $theme_path;?>app/js/2.3d061467.chunk.js"></script>
